...
export default function Fibonacci() {
    ...
    return <main className="flex flex-col items-center">
        <h1 className="mt-8 font-bold text-4xl">Compare Time of Normal Vs. Memoization Fibonacci</h1>
        ...
        <div className="mt-5 grid grid-cols-2 gap-4">
            <div className="">
                ...
                <h1>{normalFibonacciPerformance.toFixed(2)} ms</h1>
            </div>
            <div className="">
                <h1>Memoization Fibonacci Performance</h1>
                <h1>{memoFibonacciPerformance.toFixed(2)} ms</h1>
            </div>
        </div>
    </main>
}